 ...
 * 
 */
public class TrajectoryGetRequestParam extends RequestParam
{
	private static final String	METHOD			= "get_trajectory";
	/**
	 * 所有字段
	 */
	 ...
	 * 不添加fields参数也按此字段返回
	 */
	public static final String	FIELD_DEFAULT	= TrajectoryGetRequestParam.FIELDS_ALL;
	/**
	 * 用户
	 */
	private String				uid;
	 ...
	 * 需要获取的字段
	 */
	private String				fields			= TrajectoryGetRequestParam.FIELD_DEFAULT;

	public TrajectoryGetRequestParam(String uid, String pid)
	{
		super();
		this.uid = uid;
		this.pid = pid;
	 ...
	 *            需要获取的字段
	 */
	public TrajectoryGetRequestParam(String uid, String pid, String fields)
	{
		this.uid = uid;
		this.pid = pid;
		setFields(fields);
	...
	public Bundle getParams() throws AidException
	{
		...
		parameters.putString("method", TrajectoryGetRequestParam.METHOD);
		if (fields != null)
		{
